...
> To optimize an existing artefact: use `/add.build [type] [name]` → the design phase detects the artefact already exists and presents analysis vs building-commands before editing.
...
**If complex:** Recommend `/add.plan` first.
