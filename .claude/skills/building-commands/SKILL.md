...
command loads the product one with `.claude/skills/add-final-report/SKILL.md`. **They carry the same seven
...
each rule starting on an infinitive and none numbered; `.claude/commands/NAME.md` and `.claude/skills/NAME/FILE` for
