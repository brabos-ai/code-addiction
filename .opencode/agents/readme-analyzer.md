---
description: Analyzes README.md against a Change Payload and writes an exact edit report without modifying README.md. Use during documentation synchronization.
mode: subagent
permission:
  "*": deny
  read: allow
  edit:
    "*": deny
    ".tmp/sync/readme-report.json": allow
---
