---
description: Analyzes web/public SVGs against a Change Payload and writes a text-only edit report. Use during documentation synchronization.
mode: subagent
permission:
  "*": deny
  read: allow
  edit:
    "*": deny
    ".tmp/sync/svg-report.json": allow
---
