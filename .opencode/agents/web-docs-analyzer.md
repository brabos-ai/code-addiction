---
description: Analyzes docs.astro against a Change Payload and writes an exact edit report without modifying docs.astro. Use during documentation synchronization.
mode: subagent
permission:
  "*": deny
  read: allow
  edit:
    "*": deny
    ".tmp/sync/web-docs-report.json": allow
---
