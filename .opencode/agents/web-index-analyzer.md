---
description: Analyzes index.astro against a Change Payload and writes an exact edit report without modifying index.astro. Use during documentation synchronization.
mode: subagent
permission:
  "*": deny
  read: allow
  edit:
    "*": deny
    ".tmp/sync/web-index-report.json": allow
---
