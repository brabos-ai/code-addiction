---
description: Closes out internal work with gates, a delivery-index entry, a changelog, the gh merge and cleanup.
---
...
Commit the entry and the changelog as **one commit on the branch**, message per `.opencode/skills/add-commit/SKILL.md`. Then push.
