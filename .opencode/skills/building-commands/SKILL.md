...
command loads the product one with `.opencode/skills/add-final-report/SKILL.md`. **They carry the same seven
...
each rule starting on an infinitive and none numbered; `.opencode/commands/NAME.md` and `.opencode/skills/NAME/FILE` for
