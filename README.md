...
[![CI](https://github.com/xmaiconx/fnd-commands-scripts/actions/workflows/ci.yml/badge.svg)](https://github.com/xmaiconx/fnd-commands-scripts/actions/workflows/ci.yml)
...
- A shared core in `.fnd/` (commands, scripts, skills, templates)
...
- Open a [GitHub Issue](https://github.com/xmaiconx/fnd-commands-scripts/issues)
