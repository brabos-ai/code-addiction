...
const ADD_DIRS = ['.codeadd', '.add', '.claude', '.agent', '.agents', '.codex', '.cursor', '.kilocode', '.opencode', '.zcode'];
const GLOBAL_ADD_DIRS = ['.codeadd', '.claude', '.agents', '.codex', '.config/opencode', '.zcode'];
