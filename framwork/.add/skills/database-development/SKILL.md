...
{"rules":["interfaces not classes","camelCase props","ref enums from @add/domain","include id,createdAt,updatedAt","include accountId for multi-tenant"]}
...
### Build
- [ ] Build passes: `npm run build -w @add/database -w @add/domain`
