...
> **DOCUMENTATION STYLE:** Seguir padrões definidos em `.add/skills/documentation-style/SKILL.md`
...
ls .add/skills/documentation-style/SKILL.md 2>/dev/null
ls .add/skills/updating-claude-documentation/SKILL.md 2>/dev/null
```
...
```bash
cat .add/skills/updating-claude-documentation/SKILL.md
```
...
**Correção:** Criar CLAUDE.md seguindo `.add/skills/updating-claude-documentation/SKILL.md`
