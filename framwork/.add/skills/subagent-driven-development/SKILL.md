...
**Reference scripts:**
- `bash .add/scripts/feature-status.sh` - Get feature context
- `bash .add/scripts/architecture-discover.sh` - Codebase structure overview

**Skills to compose:**
- Backend: `.add/skills/backend-development/SKILL.md`
- Database: `.add/skills/database-development/SKILL.md`
- Frontend: `.add/skills/frontend-development/SKILL.md` + `.add/skills/ux-design/SKILL.md`
- Review: `.add/skills/code-review/SKILL.md`
...
```bash
bash .add/scripts/log-jsonl.sh "docs/features/${FEATURE_ID}/decisions.jsonl" "<type>" "<agent>" '"decision":"[what]","reason":"[why]"'
```

### Central File (consolidated by /add-done)

`.add/project/decisions.jsonl` — all project decisions, consolidated at feature completion.
