...
Load skill `add-ux-design` files `shadcn-docs.md`, `tailwind-v3-docs.md`, `motion-dev-docs.md`. Follow skill `add-ux-design`'s `## Layout Tree Notation`, `## Component Composition`, and `## Design Contract Dimensions` sections for the notation spec — reference them, do not restate the tables here.
