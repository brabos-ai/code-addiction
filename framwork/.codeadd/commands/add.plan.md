...
3. Write `${SCOPE_DIR}/design.md` per the `feature-design` schema (Screens · Components · Flows · Tokens · References — respect its compression rules and hard bans), consolidating the flow + layout outputs. Frontmatter:
