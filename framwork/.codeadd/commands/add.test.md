...
2. IF WIKI:present in status.sh output: read {{addpath:wiki/index.md}}, then {{addpath:wiki/domains/[AREA].md}} (+ {{addpath:wiki/conventions.md}} when conventions matter, especially any "Testing" topic covered there)
