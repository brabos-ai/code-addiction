...
IF USER REQUESTS DOCUMENT:
  ...
  ✅ DO: Use Business Style format (read .fnd/skills/documentation-style/business.md)
...
1. Read documentation style skill:
   cat .fnd/skills/documentation-style/business.md
...
**FORMAT:** Use Business Style (`.fnd/skills/documentation-style/business.md` - section brainstorm/)
