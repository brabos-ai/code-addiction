...
IF SKILL NOT LOADED:
  ...
  ✅ DO: cat .fnd/skills/saas-copy/SKILL.md
...
```bash
/fnd-copy [objective]           # Generate copy for specific objective
/fnd-copy                       # Ask for objective
```
...
```bash
cat .fnd/skills/saas-copy/SKILL.md
cat .fnd/skills/saas-copy/formulas.md
cat .fnd/skills/saas-copy/examples.md
```
...
3. **Create landing page** - Use the brief with `/fnd-landing`:
   ```
   /fnd-landing
...
/fnd-copy product-launch

# Generate copy for feature promotion
/fnd-copy feature-api-promo

# Generate copy for campaign
/fnd-copy black-friday-2025
```
