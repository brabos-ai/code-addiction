...
IF UX-DESIGN SKILL NOT LOADED:
  ...
  ⛔ DO: Read .fnd/skills/ux-design/SKILL.md FIRST
...
Grep pattern="[component]" path=".fnd/skills/ux-design/shadcn-docs.md"
Grep pattern="[utility]" path=".fnd/skills/ux-design/tailwind-v3-docs.md"
Grep pattern="[pattern]" path=".fnd/skills/ux-design/motion-dev-docs.md"
Grep pattern="[chart]" path=".fnd/skills/ux-design/recharts-docs.md"
Grep pattern="[table]" path=".fnd/skills/ux-design/tanstack-table-docs.md"
```
...
4. Load .fnd/skills/ux-design/ux-laws-principles.md
5. Load .fnd/skills/ux-design/modern-patterns.md
...
5. Load .fnd/skills/ux-design/shadcn-docs.md
6. Load .fnd/skills/ux-design/tailwind-v3-docs.md
7. Load .fnd/skills/ux-design/motion-dev-docs.md
...
**Pre-check:** `cat .fnd/skills/documentation-style/design.md 2>/dev/null`
...
**Skill:** .fnd/skills/ux-design/SKILL.md
...
**Skill:** .fnd/skills/ux-design/SKILL.md (MUST load for implementation)
```
