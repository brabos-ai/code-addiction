...
READ-ONLY FOR CODE:
  ...
  ⛔ DO NOT MODIFY: Commands (.fnd/commands/) or Skills (.fnd/skills/)
...
ALLOWED:
  ...
  ✅ MAY RUN: bash .fnd/scripts/feature-init.sh (Step 1 only)
...
```bash
bash .fnd/scripts/feature-init.sh
```
...
```bash
Read .fnd/templates/feature-about-template.md
Read .fnd/templates/feature-discovery-template.md
```
...
2. **Codebase Discovery Agent** [read-write, standard]
   ...
   - **Prompt:**
     Read `.fnd/skills/feature-discovery/SKILL.md` and `.fnd/skills/documentation-style/SKILL.md`.
...
#### Load Skills
```
.fnd/skills/documentation-style/SKILL.md
.fnd/skills/documentation-style/business.md
.fnd/skills/feature-specification/SKILL.md
.fnd/skills/feature-discovery/SKILL.md
```
...
Next: /design | /plan | /fnd-dev | /autopilot
```
