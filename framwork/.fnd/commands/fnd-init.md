...
STEP 7: Suggest next step                  → /fnd-feature
```
...
IF SKILL product-discovery NOT LOADED:
  ...
  ✅ DO: Load .fnd/skills/product-discovery/SKILL.md
...
```bash
cat .fnd/skills/product-discovery/SKILL.md
```
...
```bash
cat .fnd/skills/documentation-style/SKILL.md
```
...
**`/fnd-feature`** → Create the first MVP feature
...
- Suggest /fnd-feature at the end
