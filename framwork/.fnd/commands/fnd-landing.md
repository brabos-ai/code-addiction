...
IF SKILL NOT LOADED:
  ...
  ⛔ DO: Execute cat .fnd/skills/landing-page-saas/SKILL.md FIRST
...
IF TEMPLATES NOT LOADED:
  ...
  ⛔ DO: Load templates for selected sections from .fnd/skills/landing-page-saas/sections/
...
```bash
cat .fnd/skills/landing-page-saas/SKILL.md
```
...
```bash
# Hero
cat .fnd/skills/landing-page-saas/sections/hero.md

# Features
cat .fnd/skills/landing-page-saas/sections/features.md

# Pricing
cat .fnd/skills/landing-page-saas/sections/pricing.md

# Social Proof
cat .fnd/skills/landing-page-saas/sections/social-proof.md

# CTA
cat .fnd/skills/landing-page-saas/sections/cta.md

# Selected aesthetic
cat .fnd/skills/landing-page-saas/aesthetics.md
```
