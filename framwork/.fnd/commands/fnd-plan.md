...
- ⛔ DO: Inform user all subfeatures are complete, run `/fnd-done`
...
BEFORE designing endpoints, read: `.fnd/skills/backend-development/SKILL.md`
...
- MUST follow `.fnd/skills/backend-development/SKILL.md` patterns
...
**MANDATORY:** Load skill BEFORE dispatch: `.fnd/skills/test-specification/SKILL.md`
...
READ: .fnd/skills/test-specification/SKILL.md — follow ALL rules.
...
- Frontend (Code): `.fnd/skills/frontend-development/SKILL.md`
- Frontend (UI): `.fnd/skills/ux-design/SKILL.md`
...
| feature-status.sh fails | STOP - show error, check .fnd setup |
