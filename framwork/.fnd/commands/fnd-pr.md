...
```bash
bash .fnd/scripts/feature-pr.sh
```
...
4) Execute: bash .fnd/scripts/feature-pr.sh --create-pr
...
```bash
bash .fnd/scripts/feature-pr.sh --create-pr
```
...
```bash
bash .fnd/scripts/feature-pr.sh --confirm-merge
```
