...
prompt: |
  ...
  - .fnd/skills/frontend-development/SKILL.md (PRIMARY - types, hooks, state, API)
  - .fnd/skills/code-review/SKILL.md (validation patterns)
  - .fnd/skills/ux-design/SKILL.md (if design.md missing or for implementation details)
  ...
  ### 6. Project Patterns Validation (if .fnd/project/*.md exists for frontend apps)
...
prompt: |
  ...
  ## SKILLS (MANDATORY)
  Read BEFORE reviewing:
  - .fnd/skills/backend-development/SKILL.md (PRIMARY - Clean Arch, RESTful, IoC/DI, DTOs, CQRS)
  - .fnd/skills/database-development/SKILL.md (Entities, Migrations, Kysely, Repositories)
  - .fnd/skills/code-review/SKILL.md (validation patterns, contracts)
  - .fnd/skills/security-audit/SKILL.md (OWASP, multi-tenancy)
  ...
  **Backend ↔ Frontend Contracts:**
  ...
  ### 8.5. Project Patterns Validation (if .fnd/project/*.md exists)
  **Backend Patterns (from .fnd/project/[APP_NAME].md):**
  ...
  **Database Patterns (from .fnd/project/DATABASE.md):**
  ...
  **Load Delivery Validation Skill:**
  ```bash
  cat .fnd/skills/delivery-validation/SKILL.md
  ```
...
**Consolidate all gates into review.md. This file is the merge prerequisite for /fnd-done.**
...
> Reviewed by: /fnd-review (model: ${MODEL})
```
...
3. Run /fnd-review again after corrections
...
- **Code Review:** `.fnd/skills/code-review/SKILL.md`
- **Delivery Validation:** `.fnd/skills/delivery-validation/SKILL.md`
- **Backend Development:** `.fnd/skills/backend-development/SKILL.md`
- **Database Development:** `.fnd/skills/database-development/SKILL.md`
- **Frontend Development:** `.fnd/skills/frontend-development/SKILL.md`
- **UX Design:** `.fnd/skills/ux-design/SKILL.md`
- **Security Audit:** `.fnd/skills/security-audit/SKILL.md`
