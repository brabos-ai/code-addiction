...
# Integra com .fnd/context.json para state persistente
# =============================================================================
...
if [ -n "$FEATURE_ID" ]; then
    ...
    if [ -d "$FEATURE_DIR" ]; then
        ...
        # Iterations context (previous /fnd-dev sessions)
...
# =============================================================================
# OUTPUT: CONTEXT (from .fnd/context.json if exists)
# =============================================================================

CONTEXT_FILE=".fnd/context.json"
...
# =============================================================================
# OUTPUT: SKILLS (available in .fnd/skills/)
# =============================================================================
...
if [ -d "$SKILLS_DIR" ]; then
    ...
    if [ -n "$SKILL_LIST" ]; then
        ...
        echo "SKILLS_PATH:.fnd/skills/{$SKILL_LIST}/SKILL.md"
    fi
fi

# =============================================================================
# OUTPUT: PROJECT PATTERNS (from .fnd/project/*.md)
# =============================================================================

PROJECT_DIR=".fnd/project"
if [ -d "$PROJECT_DIR" ]; then
    ...
    if [ -n "$PROJECT_FILES" ]; then
        ...
        echo "PROJECT_DOCS:.fnd/project/{$PROJECT_FILES}.md"
    fi
else
...
if [ "$BRANCH_TYPE" = "main" ]; then
    ...
    if [ ! -d "$FEATURE_DIR" ]; then
        ...
        RECS="/fnd-dev to implement"
    elif [ "$PHASE" = "done" ]; then
        RECS="/review or /fnd-done"
    fi
fi
