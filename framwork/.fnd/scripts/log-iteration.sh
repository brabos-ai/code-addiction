...
# Used by: /fnd-dev command (automatic at completion)
# =============================================================================
# Usage: bash .fnd/scripts/log-iteration.sh <type> <slug> <what> <files> [cmd] [--feature N] [--epic name]
#
# Args:
...
#
# Examples:
#   bash .fnd/scripts/log-iteration.sh fix save-btn-500 "validation missing DTO" "api/{ctrl,svc}.ts"
#   bash .fnd/scripts/log-iteration.sh add signup-flow "feature 1 signup" "api/{ctrl,svc}.ts" "/dev" "--feature 1"
#   bash .fnd/scripts/log-iteration.sh add signup-flow "feature 1" "api/{ctrl,svc}.ts" "/dev" "--feature 1" "--epic auth-system"
# =============================================================================
