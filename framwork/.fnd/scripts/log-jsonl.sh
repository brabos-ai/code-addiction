...
# ============================================
# Usage: bash .fnd/scripts/log-jsonl.sh <file> <type> <agent> '<extra-fields>'
#
# Args:
...
#
# Examples:
#   bash .fnd/scripts/log-jsonl.sh "docs/features/F0011-board/decisions.jsonl" \
#     "choice" "database" \
#     '"decision":"Junction table","reason":"Simpler","alternatives":["Separate tables"]'
#
#   bash .fnd/scripts/log-jsonl.sh "docs/features/F0011-board/iterations.jsonl" \
#     "add" "/dev" \
