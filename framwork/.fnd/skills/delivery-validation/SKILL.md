...
{"use":["Antes de /fnd-done (gate final)","Após /review (complementar)","Quando feature parece pronta"],"dontUse":["Durante desenvolvimento","Para validar código (usar code-review)","Sem about.md definido"]}
...
FEATURE_ID=$(bash .fnd/scripts/feature-status.sh)
...
1. Carregar skill: `cat .fnd/skills/delivery-validation/SKILL.md`
