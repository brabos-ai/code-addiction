...
> **DOCUMENTATION STYLE:** Seguir padrões definidos em `.fnd/skills/documentation-style/SKILL.md`
...
ls .fnd/skills/documentation-style/SKILL.md 2>/dev/null
ls .fnd/skills/updating-claude-documentation/SKILL.md 2>/dev/null
```
...
```bash
cat .fnd/skills/updating-claude-documentation/SKILL.md
```
...
- `changelog.md` - Registro final (gerado pelo /fnd-done)
...
**Correção:** Criar CLAUDE.md seguindo `.fnd/skills/updating-claude-documentation/SKILL.md`
