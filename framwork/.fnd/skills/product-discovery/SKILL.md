...
### WhenToUse
{"triggers":["starting new project","first time setup","need founder profile","need product blueprint","no docs/owner.md","no docs/product.md"],"auto-loaded-by":["/fnd when new project"],"creates":["docs/owner.md","docs/product.md"]}
...
11. Commit
12. Suggest next steps (/fnd-feature)
