...
> **DOCUMENTATION STYLE:** Follow standards defined in `.pff/skills/documentation-style/SKILL.md`
...
- **Complexity:** standard
- **Prompt:** Content of skill `.pff/skills/audit/context-discovery.md`
...
- **Capability:** read-write (must write output file)
- **Complexity:** standard
- **Prompt:** Content of skill `.pff/skills/audit/documentation-analyzer.md`
...
- **Capability:** read-write (must write output file)
- **Complexity:** standard
- **Prompt:** Content of skill `.pff/skills/audit/infrastructure-check.md`
...
- **Capability:** read-write (must write output file)
- **Complexity:** standard
- **Prompt:** Content of skill `.pff/skills/audit/security-analyzer.md`
...
- **Capability:** read-write (must write output file)
- **Complexity:** standard
- **Prompt:** Content of skill `.pff/skills/audit/architecture-analyzer.md`
...
- **Capability:** read-write (must write output file)
- **Complexity:** standard
- **Prompt:** Content of skill `.pff/skills/audit/data-analyzer.md`
- **Additional context:** Pass content of `context-discovery.md` and `infrastructure-report.md`
...
This command requires the following skills in `.pff/skills/audit/`:
