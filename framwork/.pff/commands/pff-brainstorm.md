...
IF USER REQUESTS DOCUMENT:
  ...
  ✅ DO: Use Business Style format (read .pff/skills/documentation-style/business.md)
...
1. Read documentation style skill:
   cat .pff/skills/documentation-style/business.md
...
**FORMAT:** Use Business Style (`.pff/skills/documentation-style/business.md` - section brainstorm/)
