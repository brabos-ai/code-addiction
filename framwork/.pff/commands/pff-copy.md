...
IF SKILL NOT LOADED:
  ...
  ✅ DO: cat .pff/skills/saas-copy/SKILL.md
...
```bash
/pff-copy [objective]           # Generate copy for specific objective
/pff-copy                       # Ask for objective
```
...
```bash
cat .pff/skills/saas-copy/SKILL.md
cat .pff/skills/saas-copy/formulas.md
cat .pff/skills/saas-copy/examples.md
```
...
3. **Create landing page** - Use the brief with `/pff-landing`:
   ```
   /pff-landing
...
/pff-copy product-launch

# Generate copy for feature promotion
/pff-copy feature-api-promo

# Generate copy for campaign
/pff-copy black-friday-2025
```
