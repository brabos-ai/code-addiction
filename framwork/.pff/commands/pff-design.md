...
IF UX-DESIGN SKILL NOT LOADED:
  ...
  ⛔ DO: Read .pff/skills/ux-design/SKILL.md FIRST
...
```bash
cat .pff/skills/ux-design/SKILL.md
```
...
Grep pattern="[component]" path=".pff/skills/ux-design/shadcn-docs.md"
Grep pattern="[utility]" path=".pff/skills/ux-design/tailwind-v3-docs.md"
Grep pattern="[pattern]" path=".pff/skills/ux-design/motion-dev-docs.md"
Grep pattern="[chart]" path=".pff/skills/ux-design/recharts-docs.md"
Grep pattern="[table]" path=".pff/skills/ux-design/tanstack-table-docs.md"
```
...
4. Load .pff/skills/ux-design/ux-laws-principles.md
5. Load .pff/skills/ux-design/modern-patterns.md
...
5. Load .pff/skills/ux-design/shadcn-docs.md
6. Load .pff/skills/ux-design/tailwind-v3-docs.md
7. Load .pff/skills/ux-design/motion-dev-docs.md
...
**Pre-check:** `cat .pff/skills/documentation-style/design.md 2>/dev/null`
...
**Skill:** .pff/skills/ux-design/SKILL.md
...
**Skill:** .pff/skills/ux-design/SKILL.md (MUST load for implementation)
```
