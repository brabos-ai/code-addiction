...
READ-ONLY FOR CODE:
  ...
  ⛔ DO NOT MODIFY: Commands (.pff/commands/) or Skills (.pff/skills/)
...
ALLOWED:
  ...
  ✅ MAY RUN: bash .pff/scripts/feature-init.sh (Step 1 only)
...
```bash
bash .pff/scripts/feature-init.sh
```
...
```bash
Read .pff/templates/feature-about-template.md
Read .pff/templates/feature-discovery-template.md
```
...
2. **Codebase Discovery Agent** [read-write, standard]
   ...
   - **Prompt:**
     Read `.pff/skills/feature-discovery/SKILL.md` and `.pff/skills/documentation-style/SKILL.md`.
...
#### Load Skills
```
.pff/skills/documentation-style/SKILL.md
.pff/skills/documentation-style/business.md
.pff/skills/feature-specification/SKILL.md
.pff/skills/feature-discovery/SKILL.md
```
...
Next: /design | /plan | /pff-dev | /autopilot
```
