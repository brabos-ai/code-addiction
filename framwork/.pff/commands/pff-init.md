...
STEP 7: Suggest next step                  → /pff-feature
```
...
IF SKILL product-discovery NOT LOADED:
  ...
  ✅ DO: Load .pff/skills/product-discovery/SKILL.md
...
```bash
cat .pff/skills/product-discovery/SKILL.md
```
...
```bash
cat .pff/skills/documentation-style/SKILL.md
```
...
**`/pff-feature`** → Create the first MVP feature
...
- Suggest /pff-feature at the end
