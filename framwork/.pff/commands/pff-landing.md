...
IF SKILL NOT LOADED:
  ...
  ⛔ DO: Execute cat .pff/skills/landing-page-saas/SKILL.md FIRST
...
IF TEMPLATES NOT LOADED:
  ...
  ⛔ DO: Load templates for selected sections from .pff/skills/landing-page-saas/sections/
...
```bash
cat .pff/skills/landing-page-saas/SKILL.md
```
...
```bash
# Hero
cat .pff/skills/landing-page-saas/sections/hero.md

# Features
cat .pff/skills/landing-page-saas/sections/features.md

# Pricing
cat .pff/skills/landing-page-saas/sections/pricing.md

# Social Proof
cat .pff/skills/landing-page-saas/sections/social-proof.md

# CTA
cat .pff/skills/landing-page-saas/sections/cta.md

# Selected aesthetic
cat .pff/skills/landing-page-saas/aesthetics.md
```
