...
- ⛔ DO: Inform user all subfeatures are complete, run `/pff-done`
...
BEFORE designing endpoints, read: `.pff/skills/backend-development/SKILL.md`
...
- MUST follow `.pff/skills/backend-development/SKILL.md` patterns
...
**MANDATORY:** Load skill BEFORE dispatch: `.pff/skills/test-specification/SKILL.md`
...
READ: .pff/skills/test-specification/SKILL.md — follow ALL rules.
...
- Frontend (Code): `.pff/skills/frontend-development/SKILL.md`
- Frontend (UI): `.pff/skills/ux-design/SKILL.md`
...
| feature-status.sh fails | STOP - show error, check .pff setup |
