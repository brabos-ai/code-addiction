...
```bash
bash .pff/scripts/feature-pr.sh
```
...
4) Execute: bash .pff/scripts/feature-pr.sh --create-pr
...
```bash
bash .pff/scripts/feature-pr.sh --create-pr
```
...
```bash
bash .pff/scripts/feature-pr.sh --confirm-merge
```
