...
prompt: |
  ...
  - .pff/skills/frontend-development/SKILL.md (PRIMARY - types, hooks, state, API)
  - .pff/skills/code-review/SKILL.md (validation patterns)
  - .pff/skills/ux-design/SKILL.md (if design.md missing or for implementation details)
  ...
  ### 6. Project Patterns Validation (if .pff/project/*.md exists for frontend apps)
...
prompt: |
  ...
  ## SKILLS (MANDATORY)
  Read BEFORE reviewing:
  - .pff/skills/backend-development/SKILL.md (PRIMARY - Clean Arch, RESTful, IoC/DI, DTOs, CQRS)
  - .pff/skills/database-development/SKILL.md (Entities, Migrations, Kysely, Repositories)
  - .pff/skills/code-review/SKILL.md (validation patterns, contracts)
  - .pff/skills/security-audit/SKILL.md (OWASP, multi-tenancy)
  ...
  **Backend ↔ Frontend Contracts:**
  ...
  ### 8.5. Project Patterns Validation (if .pff/project/*.md exists)
  **Backend Patterns (from .pff/project/[APP_NAME].md):**
  ...
  **Database Patterns (from .pff/project/DATABASE.md):**
  ...
  **Load Delivery Validation Skill:**
  ```bash
  cat .pff/skills/delivery-validation/SKILL.md
  ```
...
**Consolidate all gates into review.md. This file is the merge prerequisite for /pff-done.**
...
> Reviewed by: /pff-review (model: ${MODEL})
```
...
3. Run /pff-review again after corrections
...
- **Code Review:** `.pff/skills/code-review/SKILL.md`
- **Delivery Validation:** `.pff/skills/delivery-validation/SKILL.md`
- **Backend Development:** `.pff/skills/backend-development/SKILL.md`
- **Database Development:** `.pff/skills/database-development/SKILL.md`
- **Frontend Development:** `.pff/skills/frontend-development/SKILL.md`
- **UX Design:** `.pff/skills/ux-design/SKILL.md`
- **Security Audit:** `.pff/skills/security-audit/SKILL.md`
