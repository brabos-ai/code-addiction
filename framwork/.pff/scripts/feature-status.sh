...
# Integra com .pff/context.json para state persistente
# =============================================================================
...
if [ -n "$FEATURE_ID" ]; then
    ...
    if [ -d "$FEATURE_DIR" ]; then
        ...
        # Iterations context (previous /pff-dev sessions)
...
# =============================================================================
# OUTPUT: CONTEXT (from .pff/context.json if exists)
# =============================================================================

CONTEXT_FILE=".pff/context.json"
...
# =============================================================================
# OUTPUT: SKILLS (available in .pff/skills/)
# =============================================================================
...
if [ -d "$SKILLS_DIR" ]; then
    ...
    if [ -n "$SKILL_LIST" ]; then
        ...
        echo "SKILLS_PATH:.pff/skills/{$SKILL_LIST}/SKILL.md"
    fi
fi

# =============================================================================
# OUTPUT: PROJECT PATTERNS (from .pff/project/*.md)
# =============================================================================

PROJECT_DIR=".pff/project"
if [ -d "$PROJECT_DIR" ]; then
    ...
    if [ -n "$PROJECT_FILES" ]; then
        ...
        echo "PROJECT_DOCS:.pff/project/{$PROJECT_FILES}.md"
    fi
else
...
if [ "$BRANCH_TYPE" = "main" ]; then
    ...
    if [ ! -d "$FEATURE_DIR" ]; then
        ...
        RECS="/pff-dev to implement"
    elif [ "$PHASE" = "done" ]; then
        RECS="/review or /pff-done"
    fi
fi
