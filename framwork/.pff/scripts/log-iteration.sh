...
# Used by: /pff-dev command (automatic at completion)
# =============================================================================
# Usage: bash .pff/scripts/log-iteration.sh <type> <slug> <what> <files> [cmd] [--feature N] [--epic name]
#
# Args:
...
#
# Examples:
#   bash .pff/scripts/log-iteration.sh fix save-btn-500 "validation missing DTO" "api/{ctrl,svc}.ts"
#   bash .pff/scripts/log-iteration.sh add signup-flow "feature 1 signup" "api/{ctrl,svc}.ts" "/dev" "--feature 1"
#   bash .pff/scripts/log-iteration.sh add signup-flow "feature 1" "api/{ctrl,svc}.ts" "/dev" "--feature 1" "--epic auth-system"
# =============================================================================
