...
{"rules":{"files":"kebab-case or PascalCase","classes":"PascalCase","interfaces":"I+PascalCase","dbColumns":"snake_case","variables":"camelCase","packages":"@pff/[name]"}}
...
{"patterns":[{"type":"DTOs local","style":"./dtos"},{"type":"Entities/Enums","style":"@pff/domain"},{"type":"Repositories","style":"@pff/database"},{"type":"Shared services","style":"../../shared/services"}]}
