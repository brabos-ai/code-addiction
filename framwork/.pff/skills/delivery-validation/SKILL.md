...
{"use":["Antes de /pff-done (gate final)","Após /review (complementar)","Quando feature parece pronta"],"dontUse":["Durante desenvolvimento","Para validar código (usar code-review)","Sem about.md definido"]}
...
FEATURE_ID=$(bash .pff/scripts/feature-status.sh)
...
1. Carregar skill: `cat .pff/skills/delivery-validation/SKILL.md`
