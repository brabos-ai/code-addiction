...
> **DOCUMENTATION STYLE:** Seguir padrões definidos em `.pff/skills/documentation-style/SKILL.md`
...
ls .pff/skills/documentation-style/SKILL.md 2>/dev/null
ls .pff/skills/updating-claude-documentation/SKILL.md 2>/dev/null
```
...
```bash
cat .pff/skills/updating-claude-documentation/SKILL.md
```
...
- `changelog.md` - Registro final (gerado pelo /pff-done)
...
**Correção:** Criar CLAUDE.md seguindo `.pff/skills/updating-claude-documentation/SKILL.md`
