...
description: Use when creating commands, skills, docs, or any PFF resource - provides mandatory compression patterns to minimize token consumption while preserving clarity
---
...
Every token counts. Resources must be compressed without losing clarity. This skill defines mandatory patterns for all PFF outputs.
