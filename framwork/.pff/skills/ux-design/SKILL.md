...
**Support Files:**
- `.pff/skills/ux-design/ux-laws-principles.md` - UX Laws, Cognitive Load, Mental Models
- `.pff/skills/ux-design/modern-patterns.md` - Interaction patterns, Visual trends, Performance UX
- `.pff/skills/ux-design/ux-writing.md` - Microcopy, Error messages, Empty states
...
{"recharts":".pff/skills/ux-design/recharts-docs.md"}
{"tanstackTable":".pff/skills/ux-design/tanstack-table-docs.md"}
{"tanstackQuery":".pff/skills/ux-design/tanstack-query-docs.md"}
{"tanstackRouter":".pff/skills/ux-design/tanstack-router-docs.md"}
{"uxLaws":".pff/skills/ux-design/ux-laws-principles.md"}
{"modernPatterns":".pff/skills/ux-design/modern-patterns.md"}
{"uxWriting":".pff/skills/ux-design/ux-writing.md"}
